    ...
    <section className="container mx-auto py-20 sm:py-28 px-4 md:px-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-8 h-full">
        ...
        <Link
          ...
          className="group relative flex flex-col overflow-hidden rounded-lg border border-border bg-card/40 backdrop-blur-sm transition-all hover:border-accent/50 lg:col-start-1 lg:row-start-1 lg:row-span-2 min-h-[500px] lg:min-h-[700px]"
        >
        ...
        <Link
          ...
          className="group relative flex flex-col overflow-hidden rounded-lg border border-border bg-card/40 backdrop-blur-sm transition-all hover:border-accent/50 lg:col-start-2 lg:row-start-1 min-h-[300px]"
        >
          <div className="relative w-full h-full overflow-hidden flex-grow">
            {urbanEquipmentImage && (
              <Image
        ...
        <Link
          ...
          className="group relative flex flex-col overflow-hidden rounded-lg border border-border bg-card/40 backdrop-blur-sm transition-all hover:border-accent/50 lg:col-start-2 lg:row-start-2 min-h-[300px]"
        >
          <div className="relative w-full h-full overflow-hidden flex-grow">
